// Why are there two different versions of this file?
...
typedef struct
{
	...
	int     buf [ 3 ];  // ? push-back buffer for unread operations, used by unreadc
...
#define STR2   ( x )        #x  // converts token into string literal? For example, STR2(p = "foo\n";) outputs "p = \"foo\\n\";"
                                //  https://en.wikipedia.org/wiki/C_preprocessor
#define STR    ( x )        STR2( x )  // why?

#define error  ( ... )      errorf( __FILE__ ":" STR( __LINE__ ), NULL,             __VA_ARGS__ )  //  __FILE__ and __LINE__ are "c standard predifined macros"
